...
#define EU433_NUM_DR         7   /* DR0-DR6 (DR6: SF7/250kHz, DR7: FSK not supported by driver) */
...
#define EU433_DEFAULT_TX_POWER 12  /* Max EIRP: 12.15 dBm */

/* EU433 frequency band limits (433.05 - 434.79 MHz) */
#define EU433_FREQ_MIN       433050000U
#define EU433_FREQ_MAX       434790000U

/* EU433 default channels */
#define EU433_CH0_FREQ       433175000U
#define EU433_CH1_FREQ       433375000U
#define EU433_CH2_FREQ       433575000U

/* EU433 join accept channels */
#define EU433_JA_CH0_FREQ    433175000U
#define EU433_JA_CH1_FREQ    433375000U
#define EU433_JA_CH2_FREQ    433575000U

static const struct region_dr eu433_dr_table[EU433_NUM_DR] = {
...
static const uint16_t eu433_dr_max_toa_ms[EU433_NUM_DR] = {
	/* DR0 SF12/125k */ 1600,
	/* DR1 SF11/125k */  900,
	/* DR2 SF10/125k */  500,
	/* DR3 SF9/125k  */  300,
...
static const uint8_t eu433_max_payload[EU433_NUM_DR] = {
	/* DR0 */  59,
	/* DR1 */  59,
	/* DR2 */  59,
	/* DR3 */ 123,
...
static const uint8_t eu433_rx1_dr_map[EU433_NUM_DR][EU433_NUM_DR] = {
	/* DR0: */ {0, 0, 0, 0, 0, 0, 0},
	/* DR1: */ {1, 0, 0, 0, 0, 0, 0},
	/* DR2: */ {2, 1, 0, 0, 0, 0, 0},
	/* DR3: */ {3, 2, 1, 0, 0, 0, 0},
...
static const uint32_t eu433_ch_freq[EU433_NUM_CH] = {
	EU433_CH0_FREQ,
	EU433_CH1_FREQ,
	EU433_CH2_FREQ,
};
