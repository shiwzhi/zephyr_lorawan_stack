...
struct lorawan_ctx {
	...
	bool class_c_active;
	bool class_c_paused;
	volatile bool class_c_shutdown;
	...
	/* Sticky MAC answer flags (per spec: repeat until Class A downlink) */
	bool rx_param_setup_ans_pending;
	bool dl_channel_ans_pending;
	bool rx_timing_setup_ans_pending;
